             ...
             <table style="width: 100%;" cellspacing="0" cellpadding="0">
                 ...
                 <tr>
                     <td style="text-align: center;">
                         ...
                         <p style="color: #4B5563;font-size: 2rem;font-family: 'Arial Black', sans-serif">Votre kit KIT({{ $reabonnement->kit->unpay_kit->kit_number }}) a été réabonné avec succès.<br>
