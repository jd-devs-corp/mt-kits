                        ...
                        <rect width="24" height="24" fill="white"/>
                            ...
                            <div class="sm:hidden sd:hidden  lg:flex">
                                ...
                                @else
                                    ...
                                    <a
                                        href="/supplier"
                                        class="rounded-md bg-dark bg-opacity-20 px-6 py-2 text-base font-medium text-dark duration-300 ease-in-out hover:bg-opacity-100 hover:text-dark"
                                    >
                                        Fournisseur
                                    </a>
                                @endif
            ...
            <div class="-mx-4 flex flex-wrap items-center">
                <div class="w-full px-4">
                    ...
                    >
                        ...
                        <h1 class="text-5xl">La plateforme <span class="auto-type font-extrabold"
