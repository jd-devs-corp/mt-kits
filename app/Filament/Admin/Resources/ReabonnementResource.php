...
class ReabonnementResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Filament\Admin\Resources\ReabonnementResource\Pages\ListReabonnements::route('/'),
            // 'create' => Pages\CreateReabonnement::route('/create'),
            'view' => \App\Filament\Admin\Resources\ReabonnementResource\Pages\ViewReabonnement::route('/{record}'),
            'edit' => \App\Filament\Admin\Resources\ReabonnementResource\Pages\EditReabonnement::route('/{record}/edit'),
        ];
    }
}
